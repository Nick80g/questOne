...
<div>
  ...
  <p>Ты стоишь на борту космического корабля. Наконец то начинается твое путешествие. Перед тобой твой экипаж.</p>
</div>
<form class="form-horizontal" method="post" action="init">
  <fieldset>
    <legend></legend>
    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="textinput">Введите имя</label>
      <div class="col-md-4">
